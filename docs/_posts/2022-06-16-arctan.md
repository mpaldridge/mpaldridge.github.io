...
$$ \arctan x  + \arctan \frac{1}{x} = \frac{\pi}{4} , $$
...
respectively, and these angles add up to $\pi/4$ (because, together with the right angle of $\pi/2$, all three angles in the traingle add to $\pi$).
