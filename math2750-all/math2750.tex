...
\item
  ...
  \item
    \textbf{Computational Worksheet 2 (Assessment 2):} \href{computing/C2.html}{{[}HTML format{]}} \href{computing/C2.Rmd}{{[}Rmd format{]}} This worksheet is assessed, and is due on Thursday 18 March at 2pm.
  \end{itemize}
\end{itemize}
